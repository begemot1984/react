...
import { PAGE_ABOUT, PAGE_CATALOG, PAGE_CONTACTS } from "../common/constants";
            ...
            <section>
              ...
              <ul className="nav flex-column">
                <li className="nav-item">
                  <Link to={PAGE_ABOUT} className="nav-link">
                    О магазине
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to={PAGE_CATALOG} className="nav-link">
                    Каталог
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to={PAGE_CONTACTS} className="nav-link">
                    Контакты
                  </Link>
                </li>
              </ul>
